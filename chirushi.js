document.querySelector('.btn-primary').addEventListener('click', function() {    
    alert('You will now be redirected to the official ferrari website!');
  });
...
document.querySelectorAll('a[href^="#"]').forEach(anchor => {https://www.incredibleindia.org/content/incredible-india-v2/en.html
